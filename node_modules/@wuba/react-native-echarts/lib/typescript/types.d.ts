...
export type HandlerName = 'click' | 'dblclick' | 'mousewheel' | 'mouseout' | 'mouseup' | 'mousedown' | 'mousemove' | 'contextmenu';
...
export type RNGestureHandlerGestureFactory = (defaultGestures: DefaultRNGestures, dispatchEvents: DispatchEvents) => ComposedGesture | GestureType | GestureType[];
